...
void ofApp::draw()
{
	...
	// fb_osc1_pp.draw(0, 0);
	shader_osc0.setUniformTexture("cam1", fb_osc1_pp.getTexture(), 0);
	...
	// fb_osc0_pp.draw(0, 0);
	shader_osc1.setUniformTexture("tex0", fb_osc0_pp.getTexture(), 0);
	...
	/*
	fb_osc0_pp.draw(0, 0, 320, 240);
	// fb_osc0.draw(0, 0, 320, 240);
	fb_osc1_pp.draw(320, 0, 320, 240);
	// fb_osc1.draw(320, 0, 320, 240);
	cam1.draw(0, 240, 320, 240);
	*/
